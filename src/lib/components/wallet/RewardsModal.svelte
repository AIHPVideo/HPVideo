        ...
        {:else}
          <div class="max-h-[80vh] xs:h-auto flex flex-col">
            <div class="  p-6 shadow-md sm:mt-4 mt-0 flex-1">
              ...
              <div
                class="flex flex-col md:flex-row justify-between space-x-0 md:space-x-4 items-stretch max-h-[50vh] overflow-y-auto"
              >
                <div
              ...
              <div
                class="text-center mt-8 flex justify-center gap-4 items-center flex-col md:flex-row"
              >
                <p
                  class="
								hidden sm:block
