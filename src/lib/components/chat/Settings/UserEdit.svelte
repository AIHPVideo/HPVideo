...
<div>
  <div class=" space-y-3 pr-1.5 overflow-y-scroll max-h-[25rem]">
				...
				<div class="flex-1 flex flex-col self-center gap-0.5">
					...
					<div>
						...
						<button
							class=" text-xs text-center text-gray-800 dark:text-gray-400 rounded-md px-4 py-0.5 bg-gray-100 dark:bg-gray-850"
							on:click={async () => {
								const url = "/static/default_headimg.jpg";
      ...
      <hr class=" dark:border-gray-700 my-4" />
			<div class="py-2">
				<div class="flex flex-row items-center w-full">
					<div class="mb-1 text-sm font-medium mr-1">{$i18n.t('Name')}:</div>
					<div class="flex-1">
						<input
      ...
      <div class="flex justify-center py-5 text-sm font-medium">
        <button
          class="px-4 w-[80%] py-2 primaryButton text-gray-100 transition rounded-lg"
          on:click={async () => {
